...
async function main(): Promise<void> {
  ...
  const results = {
    ...
    semantic: [
      { dimension: "assumptions_surfaced", average: 5, passed: true },
      { dimension: "citations_grounded", average: 5, passed: true },
      { dimension: "math_consistent", average: 5, passed: true },
      { dimension: "prose_clear", average: 5, passed: true },
      { dimension: "scope_aligned", average: 5, passed: true },
    ],
